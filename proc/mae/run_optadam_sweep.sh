...
CUDA_VISIBLE_DEVICES=0 python examples/examples_train_blindtrace.py --config proc/mae/configs/optim_v1_lr5e-4_wd1e-2.yaml &
CUDA_VISIBLE_DEVICES=1 python examples/examples_train_blindtrace.py --config proc/mae/configs/optim_v1_lr7p5e-4_wd1e-2.yaml
CUDA_VISIBLE_DEVICES=0 python examples/examples_train_blindtrace.py --config proc/mae/configs/optim_v1_lr1e-3_wd1e-2.yaml &
CUDA_VISIBLE_DEVICES=1 python examples/examples_train_blindtrace.py --config proc/mae/configs/optim_v1_lr2e-3_wd1e-2.yaml
CUDA_VISIBLE_DEVICES=0 python examples/examples_train_blindtrace.py --config proc/mae/configs/optim_v1_lr3e-3_wd1e-2.yaml &
CUDA_VISIBLE_DEVICES=1 python examples/examples_train_blindtrace.py --config proc/mae/configs/optim_v1_lr5e-3_wd1e-2.yaml
