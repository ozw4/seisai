...
```yaml
paths:
  segy_files: /workspace/proc/fbpick/site54/oof/site54_oof_6fold_lists/folds/foldXX/train_sgy.txt
  fb_files: /workspace/proc/fbpick/site54/oof/site54_oof_6fold_lists/folds/foldXX/train_fb.txt
  infer_segy_files: /workspace/proc/fbpick/site54/oof/site54_oof_6fold_lists/folds/foldXX/inner_valid_sgy.txt
  infer_fb_files: /workspace/proc/fbpick/site54/oof/site54_oof_6fold_lists/folds/foldXX/inner_valid_fb.txt
  out_dir: /workspace/proc/fbpick/site54/oof/coarse_foldXX_train_out
```
...
```yaml
paths:
  segy_files: /workspace/proc/fbpick/site54/oof/site54_oof_6fold_lists/folds/foldXX/heldout_sgy.txt
  out_dir: /workspace/proc/fbpick/site54/oof/coarse_oof/foldXX
infer:
  ckpt_path: /workspace/proc/fbpick/site54/oof/coarse_foldXX_train_out/ckpt/best.pt
```
