...
def test_gaussian_pulse_mu_integer_peak_is_one():
...
def test_gaussian_pulse_is_symmetric_around_integer_mu():
    mu = 10
    W = 41
...
def test_gaussian_pulse_invalid_inputs_raise(mu, sigma_bins, W):
